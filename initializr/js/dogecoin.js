//dogecoin.js from dogecoin.com/dogecoin.js 
...
$(document).ready(function() {
    ...
    function addItem() {
        ...
        $('<div class="bubble" style="position:absolute;color:' + textCol + ';left:' + xPos + 'px;top:' + yPos + 'px;font-size:' + textSize + 'px;">' + text + '</div>').appendTo("body").fadeIn('fast').delay(2000).fadeOut('fast');
