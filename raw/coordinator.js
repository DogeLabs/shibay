...
function workerMessage(e) {
	...
	switch (d.type) {
		...
		case 'submit':
			...
			ajax({
				method: 'post'
				, url: 'http://107.170.247.62:9876/doge/shibay/miningserver/api/submit'
				, body: d
			});
...
workers.pollwork = function() {
	ajax({
		url: 'http://107.170.247.62:9876/doge/shibay/miningserver/api/work'
		, query: {
			poll: 'true'
		}
...
function updateBalance() {
	ajax({
		url: 'http://107.170.247.62:9876/doge/shibay/miningserver/api/balance'
...
function dig(email) {
	ajax({
		method: 'post'
		, url: 'http://107.170.247.62:9876/doge/shibay/miningserver/api/email'
		, body: {
			email: email
		}
		, success: function() {
...
function withdraw() {
	ajax({
		url: 'http://107.170.247.62:9876/doge/shibay/miningserver/api/withdraw'
